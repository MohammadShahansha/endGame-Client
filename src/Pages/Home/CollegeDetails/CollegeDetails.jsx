...
const CollegeDetails = () => {
    ...
    const { name, admission_dates, admission_process, events, image, research_history, research_works, sports, sports_category, _id } = college

    return (
        <div className='bg-[--bg-color]'>
            <div className="py-5 bg-[--bg-color] px-2 shadow-xl">
                ...
                <div className=" md:mx-[80px] lg:mx-[160px] text-[--text-color] ">
            ...
            <div className='bg-[--second-bg-color] pb-5'>
                <h2 className='font-bold text-[--text-color] text-4xl md:text-5xl text-center py-5'>Research <span className='text-[--main-color]'>Works</span></h2>
                <div className=''>
                    {
            ...
            <div className='pb-5'>
                <h2 className='font-bold text-[--text-color] text-4xl md:text-5xl text-center py-5'>Eve<span className='text-[--main-color]'>nts</span></h2>
                <div className='md:mx-[80px] lg:mx-[160px] px-2'>
                    {
                        events.map((item, index) => <div key={index}>
                            <div className="grid grid-cols-1 md:grid-cols-2 bg-[--second-bg-color] rounded-md items-center shadow-xl mb-5">
                                <figure className='md:p-7'><img className='md:h-[250px] md:w-[450px] rounded-md' src={item.image} alt="Album" /></figure>
                                <div className=" text-[--text-color] ps-2 pb-3">
