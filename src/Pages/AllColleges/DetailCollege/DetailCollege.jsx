    ...
    return (
        <div className='bg-[--bg-color] text-[--text-color]'>
            <div className='bg-[--second-bg-color] pt-10'>
                <h2 className='font-bold text-[--text-color] text-5xl text-center'>{name}</h2>
                <figure><img className='opacity-60 w-full mt-5' src={college_image} alt="" /></figure>

            </div>
            <div>
                <h2 className='font-bold text-[--text-color] text-5xl text-center py-5'>Educational <span className='text-[--main-color]'>Information</span></h2>
                <div className='md:w-[700px] lg:w-[900px] mx-auto px-3'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 mt-5  gap-5'>
                        <div className='bg-[--second-bg-color] rounded-2xl pt-5 ps-3'>
                            <p className='font-bold text-xl  mb-[-7px] '>Number of Resurch: <span className='font-normal text-lg'>{num_research}</span></p>
            ...
            <div className='bg-[--second-bg-color] pt-5 mt-10'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pb-10 mx-20'>
                    {
